      ...
      <div className="container relative z-10 px-6 pt-32 pb-20">
        ...
        >
          ...
          >
            ...
            Plataforma de agentes autônomos com IA
          </motion.div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1] mb-6">
            Monetize com{" "}
            <span className="text-gradient-primary">IA autônoma</span>
            <br />
            em qualquer nicho
          </h1>

          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Agentes inteligentes, billing integrado, API gateway e marketplace — 
            tudo pronto para escalar seu SaaS de R$0 a R$100k/mês.
          </p>
